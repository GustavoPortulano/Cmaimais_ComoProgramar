//31 de julho de 2026. Sexta-feira. Noite fria. Figura 3.7: fig03_09.cpp
...
public:
    ...
    {
        return courseName;  //retirba courseName do objeto
    }   //fim da função getCourseName

    //exibe uma mensagem de boas-vindas para o usuário GradeBook
    void displayMessage()
    {
        //chama getCouseName para obter o courseName
